...
namespace gt {
    namespace coordinates {
        ...
        std::vector<std::tuple<double, double>> configuration(const std::string& shape, int Nx, int Ny,
            ...
            std::vector<std::string> acceptable_arguments{"Rectangle", "OpenRectangle", "U", "L"};
            // check if the input string is acceptable
            bool acceptable = (std::find(acceptable_arguments.begin(), acceptable_arguments.end(), shape)
